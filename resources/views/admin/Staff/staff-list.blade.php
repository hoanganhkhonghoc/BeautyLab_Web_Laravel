...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="/admin/staff/addView" class="btn btn-added"><img src="{{asset('admin/icon/plus.svg')}}" alt="img" class="me-1">Thêm tài khoản nhân viên mới</a>
            </div>
        </div>
                        ...
                        <tbody>
                            @foreach ($data['staff'] as $staff)
                                <tr>
                                    ...
                                    <td>
                                        <a class="me-3" href="/admin/staff/show/{{$staff['id']}}">
                                            <img src="{{asset('admin/icon/eye.svg')}}" alt="img">
                                        </a>
                                        <a class="me-3" href="/admin/staff/show/{{$staff['id']}}">
                                            <img src="{{asset('admin/icon/edit.svg')}}" alt="img">
                                        </a>
                                        <a class="confirm-text" href="/admin/staff/xl_deleted/{{$staff['id']}}">
