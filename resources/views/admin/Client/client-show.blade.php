...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="/admin/client/xl_edit/{{$data->id}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="pass-group">
                                    <input type="password" class=" pass-input" name="pass" placeholder="Không thể hiển thị vì lý do bảo mật !! " value="{{$data->password}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 col-12">
                        ...
                        <div class="col-lg-12">
                            ...
                            <a href="/admin/client/addView" class="btn btn-cancel">Quay lại</a>
                        </div>
                    </div>
                </form>
            </div>
